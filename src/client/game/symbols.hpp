...
namespace game
{
	...
	WEAK symbol<void(const dvar_t* dvar, float value)> Dvar_SetFloat{ 0x0, 0x1404C2A10 };
	...
	WEAK symbol<void(vec4_t a, vec4_t b, float alpha, vec4_t out)> QuatLerp{0x0, 0x1404B32D0};
